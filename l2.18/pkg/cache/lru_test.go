...
import (
	...
	mock_logger "calendar-wbf/pkg/logger/mock"
...
func TestLRUCache_GetPut(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			c, _ := cache.NewLRUCache[int, string](tc.input.capacity, mockLogger)
			var lastGet struct {
				key   int
				value string
				ok    bool
...
func TestLRUCache_Capacity(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			c, _ := cache.NewLRUCache[int, string](tc.capacity, mockLogger)
...
func TestLRUCache_NewLRUCache(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			_, err := cache.NewLRUCache[int, string](tc.capacity, mockLogger)
